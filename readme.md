...
- remove old `data-qa` attribute
- add `data-qa="nav-hover"` (not just `hover`) to the 4th nav link for testing (`Laptops & computers`)
- add `data-qa="card"` to the first card
- add `data-qa="card-hover"` (not just `hover`) to the link `Buy` inside the first card
- nav links color is not `dark` anymore (nav links should have `#060b35` color)
...
- [DEMO LINK](https://MykolaBa.github.io/layout_catalog/)
- [TEST REPORT LINK](https://MykolaBa.github.io/layout_catalog/report/html_report/)
